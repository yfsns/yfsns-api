...
return [
    ...
    'laravel' => [
        ...
        // Only enable routes in non-production environments
        'add_routes' => config('app.env') !== 'production',
    ...
    // JSON encoding options for the documentation
    'json_encode_options' => \JSON_UNESCAPED_UNICODE | \JSON_UNESCAPED_SLASHES | \JSON_PRETTY_PRINT,
