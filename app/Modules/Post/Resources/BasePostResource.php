...
abstract class BasePostResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return array_merge($this->getBaseFields($request), $this->getSpecificFields($request));
    }

    /**
     * 获取所有资源共有的基础字段
     */
    protected function getBaseFields($request): array
    {
        return [
            'id' => (string) $this->id,
            'type' => $this->getType(),
     ...
     * 由子类实现
     */
    abstract protected function getSpecificFields($request): array;
