...
class AdminPostController extends Controller
{
    ...
    public function show(int $id): JsonResponse
    {
            ...
            return response()->json([
                'code' => 200,
                'message' => '获取成功',
                'data' => new AdminPostResource($data),
            ], 200);
    }
     ...
     * 新增一条动态内容。
     *
     * @bodyParam content string required 动态内容。Example: "今天很开心！"
     ...
     * }
     */
    public function store(AdminPostStoreRequest $request): JsonResponse
    {
            $params = $request->validated();
            $userId = $request->user() ? $request->user()->id : 0;
            $data = $this->service->create($params, $userId);
    ...
    public function update(AdminPostUpdateRequest $request, int $id): JsonResponse
    {
            ...
            $data = $this->service->update($id, $params);
    ...
    public function review(AdminPostReviewRequest $request, int $id): JsonResponse
    {
            ...
            $params = $request->validated();
            $data = $this->service->reviewPost($id, $params);
