...
use App\Modules\Location\Requests\CalculateDistanceRequest;
use App\Modules\Location\Requests\GeocodeRequest;
use App\Modules\Location\Requests\GetLocationByIpRequest;
use App\Modules\Location\Requests\ReverseGeocodeRequest;
...
class LocationController extends Controller
{
    ...
    public function getDrivers(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => [
                'drivers' => $drivers,
                'default' => config('location.default_driver', 'amap'),
            ],
        ], 200);
    }
